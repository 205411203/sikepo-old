    ...
    <div class="col-md-6 py-1">
      <div class="card">
        <div class="card-header">
          <h6>Kinerja Karantina Hewan Ekspor-Impor</h6>
        </div>
        <div class="card-body">
      ...
      <div class="card">
        <div class="card-header">
          <h6>Kinerja Karantina Hewan Antar Area </h6>
        </div>
        <div class="card-body">
...
<script type="text/javascript" src="../assets/chart/dist/xlsx.full.min.js"></script>

<script type="text/javascript" src="../assets/chart/chartjs-plugin-datasource.min.js"></script>
<script>
  var chartColors = {
  red: 'rgb(255, 99, 132)',
  blue: 'rgb(54, 162, 235)'
...
var config = {
  ...
  options: {
    title: {
      display: true,
      text: 'Frekuensi Sertifikasi Karantina Hewan'
    },
    scales: {
      yAxes: [{
        id: 'Ekspor'
